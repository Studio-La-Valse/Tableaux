    ...
    public class VisualCircleOfFifths : BaseContentWrapper
    {
        ...
        public List<BaseDrawableElement> InnerRing
        {
            get
            {
                ...
                var _color = circleOfFifths.Chaser.Color;
                var color = new ColorAHSV(0.1, _color.Hue, _color.Saturation, _color.Value);
                ...
                for (var i = 1; i <= number; i++)
                {
                    ...
                    rings.Add(new DrawableCircle(new Circle(new XY(canvasLeft, canvasTop), radius), color.ToColorARGB()));
                }
        ...
        public BaseDrawableElement GlowRing
        {
            get
            {
                ...
                var _color = new ColorAHSV(0.3, color.Hue, color.Saturation, color.Value).ToColorARGB();
                ...
                return new DrawableCircle(Transformation, MainRadius + ringOffset + strokeWeight / 2, color: ColorARGB.Transparant, _color, strokeWeight);
            }
        }
        public List<BaseDrawableElement> KeyInformation
        {
            get
            {
                ...
                foreach (var keyInfo in circleOfFifths.Keys)
                {
                    ...
                    var lineColor = new ColorARGB((int)Math.Round(keyInfo.Amplitude), 255, 255, 255);
        ...
        public BaseDrawableElement ChordTriangle
        {
            get
            {
                ...
                var color = new ColorARGB((int)Math.Ceiling(maxAmplitude * 255), 255, 255, 255);
