<template>
  <div class="home-container">
    ...
    <GraphCanvas
      v-else-if="layoutMode === 'graph'"
      class="panel-content"
    />

    <CanvasComponent
      v-else-if="layoutMode === 'canvas'"
      class="panel-content"
    />
