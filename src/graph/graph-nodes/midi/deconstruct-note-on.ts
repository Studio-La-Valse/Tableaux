import { isMidiMessage, isNoteOn } from '@/midi/midi-message'
import { GraphNode } from '../../core/graph-node'
import { inputIterators } from '../../core/input-iterators'
import { GraphNodeType } from '../decorators'

@GraphNodeType('MIDI', 'Deconstruct Note On')
export class DeconstructNoteOn extends GraphNode {
  private inputNote
