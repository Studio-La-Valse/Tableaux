...
export type Filter = Shape & { blur?: Blur; dropShadow?: DropShadow };

export function hasFilter(shape: Shape): shape is Filter {
...
export function hasDropShadow(
  object: Shape
): object is Shape & { dropShadow: DropShadow } {
  return (
